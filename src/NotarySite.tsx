          ...
          <div className="mx-auto max-w-6xl rounded-4xl bg-[#fff9f2] px-6 py-16 shadow-sm ring-1 ring-[#d3bfa4]/70">
            ...
            <div className="mt-8 divide-y divide-[#e8dcc8]">
              {[
                ...
                {q: "What can you draft?", a: "Legal Document Drafting costs $65 per affidavit or $50 per travel consent letter, before and after 6 PM, plus HST. Commissioning and notarization are separate. Other document work requires review."},
                ...
                {q: "Can I request an urgent appointment?", a: "From 6 PM, urgent requests are online only and need at least 30 minutes’ notice. Eligible commissioning is double the normal service price. Drafting costs $65 per affidavit or $50 per travel consent letter before and after 6 PM. After-hours mediation requires an eligibility and pricing review."},
              ].map((item, i) => (
